...
public class EventsDbAdapter {
     ...
     */
    public long createEvent(String title, String date, String time) {
    ...
    public Cursor fetchEvent(long rowId) throws SQLException {
        ...
        Cursor mCursor =
            ...
            mDb.query(true, DATABASE_TABLE, new String[] {KEY_ROWID,
                    KEY_TITLE, KEY_DATE, KEY_TIME}, KEY_ROWID + "=" + rowId, null,
                    null, null, null, null);
        if (mCursor != null) {
            mCursor.moveToFirst();
        }
     ...
     */
    public boolean updateEvent(long rowId, String title, String date, String time) {
